...
export const aboutData = {
  ua: {
    p1: "Громадська організація «Еко Місто Чернігів» — це урбаністична ініціатива, спрямована на покращення якості життя через проєкти активації публічних просторів та формування спільнот. ",
